module RW_LOGIC(cpu_data , RD, WR, A0,CS, 
                ctrl_data, RW, type , nr , rst, ctrl_ready_to_write);
          ...
          case(count)
            ...
            2'b00: 
              begin 
                ...
                if(A0==0 & cpu_data[3]==0)  //case of ocw2
                  begin
                    //OCW2_F =1;
                    RW=1;
                    type = 0;
                ...
                if(A0 ==0 & cpu_data[3]==1) //case of ocw3
                  begin
                    //OCW3_F=1;
                    RW=1;
                    type=0;
